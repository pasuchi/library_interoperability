...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for interoperability (com.test.pe:interoperability)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getInteroperability() { return create("interoperability"); }
    ...
    public static class TestLibraryAccessors extends SubDependencyFactory {
        private final TestUiLibraryAccessors laccForTestUiLibraryAccessors = new TestUiLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at test.ui
         */
        public TestUiLibraryAccessors getUi() { return laccForTestUiLibraryAccessors; }

    }

    public static class TestUiLibraryAccessors extends SubDependencyFactory {

        public TestUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for manifest (androidx.compose.ui:ui-test-manifest)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getManifest() { return create("test.ui.manifest"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: hiltNavigationVersion (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getHiltNavigationVersion() { return getVersion("hiltNavigationVersion"); }

            /**
             * Returns the version associated to this alias: interoperability (1.22)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getInteroperability() { return getVersion("interoperability"); }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.compose.bom
         */
        public ComposeBomVersionAccessors getBom() { return vaccForComposeBomVersionAccessors; }

    }

    public static class ComposeBomVersionAccessors extends VersionFactory  {

        public ComposeBomVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: compose.bom.version (2023.10.01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
